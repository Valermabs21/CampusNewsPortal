...
include("classes/admin_post.php");
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if ($user_data['site'] == 'admin' && $user_data['department'] == 'Administration') {
        $post = new Post();
        $id = $_SESSION['campusportal_userid'];
        ...
        echo "Only admins of the Administration are allowed to post.";
    }
}
...
<div class="container">
    ...
    <div class="main-content">
        ...
        <div class="posting-area">
                ...
                <?php if ($user_data['site'] == 'admin' && $user_data['department'] == 'Administration'): ?>
                ...
                <?php else: ?>
                    <p>Only admins of the Administration are allowed to post.</p>
                <?php endif; ?>
