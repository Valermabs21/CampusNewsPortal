...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if ($user_data['site'] == 'admin' && $user_data['department'] == 'Office of Student Affairs') {
        $post = new Post();
        $id = $_SESSION['campusportal_userid'];
        $result = $post->create_post($id, $_POST, $_FILES);

        if ($result == "") {
            header("Location: Office of Student Affairs.php");
            die;
        } else {
            echo $result;
        }
    } else {
        echo "Only admins of the Office of Student Affairs are allowed to post.";
    }
}
...
<div class="container">
    ...
    <div class="main-content">
        <div class="write-post-container">
            <div class="main">
                <h1>Welcome to Office of Student Affairs</h1>
                <p>Stay updated with the latest campus news and updates.</p>
            </div>
        </div>
        <div class="posting-area">

                <?php if ($user_data['site'] == 'admin' && $user_data['department'] == 'Office of Student Affairs'): ?>
                ...
                <?php else: ?>
                    <p>Only admins of the Office of Student Affairs are allowed to post.</p>
                <?php endif; ?>
