...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if ($user_data['site'] == 'admin' && $user_data['department'] == 'University Students Government') {
        $post = new Post();
        $id = $_SESSION['campusportal_userid'];
        $result = $post->create_post($id, $_POST, $_FILES);

        if ($result == "") {
            header("Location: University Students Government.php");
            die;
        } else {
            echo $result;
        }
    } else {
        echo "Only admins of the University Students Government are allowed to post.";
    }
}
...
<div class="container">
    ...
    <div class="main-content">
        <div class="write-post-container">
            <div class="main">
                <h1>Welcome to University Students Government</h1>
                <p>Stay updated with the latest campus news and updates.</p>
            </div>
        </div>
        <div class="posting-area">

                <?php if ($user_data['site'] == 'admin' && $user_data['department'] == 'University Students Government'): ?>
                ...
                <?php else: ?>
                    <p>Only admins of the University Students Government are allowed to post.</p>
                <?php endif; ?>
