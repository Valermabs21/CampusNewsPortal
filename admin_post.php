...
$stmt = $con->prepare("SELECT admin_comments.comment, admin_comments.date, users.username 
                        FROM admin_comments 
                        JOIN users ON admin_comments.user_id = users.userid 
                        WHERE admin_comments.post_id = ? 
                        ORDER BY admin_comments.date ASC");
...
$stmt_count = $con->prepare("SELECT COUNT(*) as comment_count FROM admin_comments WHERE post_id = ?");
...
<div id="post">
    <div>
        ...
        <a href="admin_like.php?type=post&id=<?php echo htmlspecialchars($ROW['postid']); ?>" style="text-decoration: none;">
        ...
        <a href="javascript:void(0);" onclick="shareOnFacebook('<?php echo htmlspecialchars('http://localhost/campusnewsportal/admin_post.php?id=' . $ROW['postid']); ?>')" style="text-decoration: none;">
        ...
        <div class="comments-section">
            ...
            <form method="POST" action="admin_comment.php">
