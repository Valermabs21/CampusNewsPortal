...
$stmt = $con->prepare("SELECT cas_comments.comment, cas_comments.date, users.username 
                        FROM cas_comments 
                        JOIN users ON cas_comments.user_id = users.userid 
                        WHERE cas_comments.post_id = ? 
                        ORDER BY cas_comments.date ASC");
...
$stmt_count = $con->prepare("SELECT COUNT(*) as comment_count FROM cas_comments WHERE post_id = ?");
...
<div id="post">
    <div>
        ...
        <a href="cas_like.php?type=post&id=<?php echo htmlspecialchars($ROW['postid']); ?>" style="text-decoration: none;">
        ...
        <a href="javascript:void(0);" onclick="shareOnFacebook('<?php echo htmlspecialchars('https://campusnewsportal101.000webhostapp.com/cas_post.php?id=' . $ROW['postid']); ?>')" style="text-decoration: none;">
        ...
        <div class="comments-section">
            ...
            <form method="POST" action="cas_comment.php">
