...
$stmt = $con->prepare("SELECT ict_comments.comment, ict_comments.date, users.username 
                        FROM ict_comments 
                        JOIN users ON ict_comments.user_id = users.userid 
                        WHERE ict_comments.post_id = ? 
                        ORDER BY ict_comments.date ASC");
...
$stmt_count = $con->prepare("SELECT COUNT(*) as comment_count FROM ict_comments WHERE post_id = ?");
...
<div id="post">
    <div>
        ...
        <a href="ict_like.php?type=post&id=<?php echo htmlspecialchars($ROW['postid']); ?>" style="text-decoration: none;">
       ...
       <a href="javascript:void(0);" onclick="shareOnFacebook('<?php echo htmlspecialchars('http://localhost/campusnewsportal/ict_post.php?id=' . $ROW['postid']); ?>')" style="text-decoration: none;">
        ...
        <div class="comments-section">
            ...
            <form method="POST" action="ict_comment.php">
