...
$stmt = $con->prepare("SELECT osa_comments.comment, osa_comments.date, users.username 
                        FROM osa_comments 
                        JOIN users ON osa_comments.user_id = users.userid 
                        WHERE osa_comments.post_id = ? 
                        ORDER BY osa_comments.date ASC");
...
$stmt_count = $con->prepare("SELECT COUNT(*) as comment_count FROM osa_comments WHERE post_id = ?");
...
<div id="post">
    <div>
        ...
        <a href="osa_like.php?type=post&id=<?php echo htmlspecialchars($ROW['postid']); ?>" style="text-decoration: none;">
        ...
        <a href="javascript:void(0);" onclick="shareOnFacebook('<?php echo htmlspecialchars('http://localhost/campusnewsportal/osa_post.php?id=' . $ROW['postid']); ?>')" style="text-decoration: none;">
        ...
        <div class="comments-section">
            ...
            <form method="POST" action="osa_comment.php">
