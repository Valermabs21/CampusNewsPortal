...
$stmt = $con->prepare("SELECT usg_comments.comment, usg_comments.date, users.username 
                        FROM usg_comments 
                        JOIN users ON usg_comments.user_id = users.userid 
                        WHERE usg_comments.post_id = ? 
                        ORDER BY usg_comments.date ASC");
...
$stmt_count = $con->prepare("SELECT COUNT(*) as comment_count FROM usg_comments WHERE post_id = ?");
...
<div id="post">
    <div>
        ...
        <a href="usg_like.php?type=post&id=<?php echo htmlspecialchars($ROW['postid']); ?>" style="text-decoration: none;">
        ...
        <a href="javascript:void(0);" onclick="shareOnFacebook('<?php echo htmlspecialchars('http://localhost/campusnewsportal/usg_post.php?id=' . $ROW['postid']); ?>')" style="text-decoration: none;">
        ...
        <div class="comments-section">
            ...
            <form method="POST" action="usg_comment.php">
